...
ถ้าคิวสัมภาษณ์ปกติช้าเกินกำหนดเดินทางเพราะความล่าช้าที่ต้นทาง (เช่น จากตอนที่ 3-4) จะต้องขอนัดสัมภาษณ์แบบเร่งด่วนแทน (ในระบบจริงเรียกฟีเจอร์นี้ว่า "Emergency Request") ซึ่งต้องมีเหตุผลฉุกเฉินที่แท้จริง (การท่องเที่ยว/งานส่วนตัวไม่นับ) และต้องจองคิวปกติที่มีอยู่ก่อนถึงจะเห็นสิทธิ์ขอเร่งด่วน
...
- แนะนำให้รับวัคซีนไข้กาฬหลังแอ่นไว้ด้วยถึงแม่ข้อบังคับจะระบุเฉพาะคนที่พักหอใน(ปริญญาตรี) ซึ่งจะมีชนิด 4 สายพันธุ์ ACYW) และบางรัฐอาจระบุเพิ่มขอ สายพันธุ์ B เพิ่มเติมด้วย
...
**คลินิกที่แนะนำในกรุงเทพฯ**: ที่รู้จักกันมากที่สุดคือ [Thai Travel Clinic คณะเวชศาสตร์เขตร้อน มหิดล](https://www.thaitravelclinic.com/th/vaccine-price-list/) ซึ่งเปิดตารางราคาวัคซีนไว้ชัดเจนล่วงหน้าบนเว็บ ราคาสมเหตุสมผล — ส่วนอีกที่ที่คนรู้จักน้อยกว่าแต่เป็นหน่วยงานราชการเช่นกันและใกล้กรุงเทพ คือ **หน่วยคลินิกเวชศาสตร์การเดินทางและท่องเที่ยว สถาบันบำราศนราดูร** ตึกเฉลิมพระเกียรติ ชั้น 5 โทร 02-590-3430 อีเมล tmcbamras@gmail.com [เว็บไซต์ทางการของกรมควบคุมโรค เก่าและไม่อัปเดตแล้ว](https://ddc.moph.go.th/pagecontent.php?page=475&dept=) แนะนำให้โทร/อีเมลติดต่อตรงแทน


---

## ตอนที่ 10: สิ่งที่อยากฝากไว้

<div class="callout lesson">
<p class="callout-label">สรุป 9 ข้อ</p>

1. **ควรพยายามให้ได้ Offer จากมหาวิทยาลัยก่อน** แล้วค่อยสัมภาษณ์ทุนรัฐบาล
2. **เผื่อเวลาทุกขั้นตอนราชการมากกว่าที่คิด อย่างน้อย 2 เท่าของเวลาที่ประกาศ** โดยเฉพาะขั้นตรวจสอบทางกฎหมาย (ตอนที่ 3)
3. **ตรวจเอกสารคำขอสถานะวีซ่าจากมหาลัยนตั้งแต่ต้น** อย่ารอให้มหาวิทยาลัยออกเอกสารผิดมาก่อนแล้วค่อยแก้ (ตอนที่ 4)
...
8. **จ่ายค่าธรรมเนียมวีซ่า (MRV Fee) ด้วย Mastercard** — EFT ช้าที่สุดและการรอยืนยันอาจข้ามวันหยุดสุดสัปดาห์ (ตอนที่ 7)
9. **ไปรับ-ส่งเอกสารสำคัญด้วยตัวเองในทุกขั้นตอนที่ทำได้ และถ่ายรูป/สแกนเก็บสำรองไว้เสมอ** (ตอนที่ 2)
