...
เช็คสถานะเองได้ที่ [CEAC Visa Status Check (ceac.state.gov/CEACStatTracker/Status.aspx)](https://ceac.state.gov/CEACStatTracker/Status.aspx) — เลือก **Visa Application Type** เป็น **NONIMMIGRANT VISA (NIV)** แล้วกรอก Case Number ตามที่ระบบขอ (ดูเลขนี้ได้จากใบนัดสัมภาษณ์/ใบเสร็จที่ได้รับตอนยื่นเอกสารที่สถานทูต ไม่ใช่เลข DS-160 Application ID) สถานะที่ขึ้นมีได้หลายแบบ เท่าที่เจอมามีอย่างน้อย **Administrative Processing** (ยังอยู่ระหว่างพิจารณา), **Approved** (เจ้าหน้าที่อนุมัติแล้ว รอออกเล่ม/พิมพ์วีซ่า), **Issued** (ออกวีซ่าแล้ว กำลังเตรียมส่งพาสปอร์ตคืน), และ **Refused** (ถูกปฏิเสธ) — เว็บนี้กันการดึงข้อมูลอัตโนมัติ ดังนั้นให้ยึดสถานะที่ขึ้นจริงในระบบของตัวเองเป็นหลัก ไม่ใช่รายการนี้

<div class="callout case">
<p class="callout-label">กรณีของผม</p>

หลังสัมภาษณ์เสร็จวันเดียวกัน เข้าไปเช็คระบบ CEAC แล้วขึ้นสถานะเป็น **Approved** ทันที (ไม่ใช่ Issued) — คนละสถานะกัน Approved คือเจ้าหน้าที่อนุมัติวีซ่าแล้วแต่ยังไม่ได้พิมพ์เล่ม/ไม่พร้อมส่งคืนพาสปอร์ต ต้องรอสถานะเปลี่ยนเป็น Issued อีกทีถึงจะเริ่มนับเวลาส่งพาสปอร์ตกลับ
